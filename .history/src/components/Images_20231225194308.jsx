...
const Images = () => {
  ...
  return (
    <div className="imgsContainer">
        ...
        <img onClick={ navigate("/sunsets")} src={pic2} alt="sunset" />
        <img onClick={ navigate("/sunsets")} src={pic3} alt="sunset" />
        <img onClick={ navigate("/sunsets")} src={pic4} alt="sunset" />
        <img onClick={ navigate("/sunsets")} src={pic5} alt="sunset" />
        <img onClick={ navigate("/sunsets")} src={pic6} alt="sunset" />
        </div>
    </div>
  )
}
