...
const Images = () => {
  ...
  return (
    <div className="imgsContainer">
        <div className="imgs">
        <img onClick={} src={pic1} alt="sunset" />
        <img onClick={} src={pic2} alt="sunset" />
        <img onClick={} src={pic3} alt="sunset" />
        <img onClick={} src={pic4} alt="sunset" />
        <img onClick={} src={pic5} alt="sunset" />
        <img onClick={} src={pic6} alt="sunset" />
        </div>
    </div>
  )
}
