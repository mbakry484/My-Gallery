...
const Images = () => {
  ...
  return (
    <div className="imgsContainer">
        <div className="imgs">
        <img onc src={pic1} alt="sunset" />
        <img onc src={pic2} alt="sunset" />
        <img onc src={pic3} alt="sunset" />
        <img onc src={pic4} alt="sunset" />
        <img onc src={pic5} alt="sunset" />
        <img onc src={pic6} alt="sunset" />
        </div>
    </div>
  )
}
