...
const Images = () => {
  ...
  return (
    <div className="imgsContainer">
        <div className="imgs">
        <img {handleImageClick} src={pic1} alt="sunset" />
        <img {handleImageClick} src={pic2} alt="sunset" />
        <img {handleImageClick} src={pic3} alt="sunset" />
        <img {handleImageClick} src={pic4} alt="sunset" />
        <img {handleImageClick} src={pic5} alt="sunset" />
        <img {handleImageClick} src={pic6} alt="sunset" />
        </div>
    </div>
  )
}
