...
const Randoms = () => {
  ...
  const handleFileSelected = (e) => {
    ...
    console.log(id)
    const newImg={...e.target.files,[id]:id}
    setImagesArray([...imagesArray,newImg])
  }
    ...
    <>
      ...
      <div className="sunImgsContainer">
        <div className="sunImgs">
          ...
          {imagesArray.map((imgSrc, index,id) => (         
            <img key={index,id} src={imgSrc} id="item" alt="" onClick={() =>viewImage(imgSrc)}  />
         )) }
