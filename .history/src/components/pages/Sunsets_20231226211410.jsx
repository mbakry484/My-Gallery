...
<>
   ...
   { data.imgSrc &&
    ...
    <button style={{position:'absolute',top:'10px',right:'10px', backgroundColor:'blue'}}>X </button>
    <button style={{position:'absolute',top:'48%',right:'10px', backgroundColor:'green'}}>Next </button>
    <button style={{position:'absolute',top:'48%',left:'10px', backgroundColor:'green'}}>Previous </button>
