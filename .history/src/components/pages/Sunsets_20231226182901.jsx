...
const Sunsets = () => {
  ...
  {
    <div className=''> 
    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odit commodi modi cupiditate, vitae, numquam esse, accusamus officia porro voluptatem dolore atque tempore. Accusantium facilis, culpa itaque mollitia rerum deserunt molestias.</p></div>
    console.log("hello")
  }
