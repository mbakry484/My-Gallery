...
<>
   ...
   { data.imgSrc &&
    ...
    <button style={{position:'absolute',top:'10',right:'10px', backgroundColor:'red'}} >X</button>
    <button style={{position:'absolute',top:'10',right:'10px', backgroundColor:'green'}} >next</button>
