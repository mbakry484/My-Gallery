...
import DraggableImage from '..DraggableImg.jsx/DraggableImage';
...
const Randoms = () => {
  ...
  const handleFileSelected = (e) => {
    ...
    setImagesArray([...imagesArray,fileSrc])
  }
        ...
        <div className="sunImgs">
          <div>
           ...
           {imagesArray.map((imgSrc, index) => (         
            <DraggableImage key={index} src={imgSrc} index={index} alt=""    
             onImageClick={(clickedImgSrc, clickedIndex) => viewImage(clickedImgSrc, clickedIndex)} />
