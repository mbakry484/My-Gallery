    ...
    <>
      {data.imgSrc && (
        ...
        >
          ...
          <button style={{ position: 'absolute', top: '48%', left: '30px', backgroundColor: 'green' }} onClick={() => DelImg()}>
            Prev{' '}
          </button>
          <button style={{ position: 'absolute', top: '85%', right: '30px', backgroundColor: 'red' }} onClick={() => imgAction('prev-img')}>
